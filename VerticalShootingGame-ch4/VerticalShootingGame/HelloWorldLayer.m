...
- (void) dealloc
{
    ...
    [_playerBlowupAnimation release];
    _playerBlowupAnimation = nil;
    
    [_enemyBlowupAnimation release];
    _enemyBlowupAnimation = nil;
    
    [_playerFlyAction release];
    _playerFlyAction = nil;
...
//                id blowup = [CCAnimate actionWithAnimation:_enemyBlowupAnimation restoreOriginalFrame:YES];
